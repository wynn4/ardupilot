...
const AP_Param::Info Copter::var_info[] = {
    ...
    // @Param: PLANCK_EMERGENCY_REACQ_TIMEOUT
    // @DisplayName: Planck Emergency Reacuire Timeout
    // @Description: Time to re-acquire tag/pos-ref before switching to high tension
    // @Range: 0 1000
    // @User: Advanced
    GSCALAR(planck_emergency_reaquire_timeout, "PLANCK_EMT_AQTO",                 PLANCK_EMT_AQTO),
