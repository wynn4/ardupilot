...
AP_MotorTempMonitor_I2CBus::AP_MotorTempMonitor_I2CBus()
{

}
AP_MotorTempMonitor_I2CBus
...
bool AP_MotorTempMonitor_I2CBus::read_word(uint8_t reg, uint16_t& data) const
{
