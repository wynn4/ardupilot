...
#define AP_SERIALMANAGER_BATTERYDJIUART_BAUD    115200
#define AP_SERIALMANAGER_BATTERYDJIUART_BUFSIZE_RX 128
#define AP_SERIALMANAGER_BATTERYDJIUART_BUFSIZE_TX 32
...
public:
    ...
    enum SerialProtocol {
        ...
        SerialProtocol_BatteryDJIUART = 24,
    };
