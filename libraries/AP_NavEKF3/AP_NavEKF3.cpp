...
const AP_Param::GroupInfo NavEKF3::var_info[] = {
    ...
    // temporary parameters for testing learning, will be removed when testing is complete
    AP_GROUPINFO("MAG_LRN_RAT", 57, NavEKF3, _mag_learn_rate, 0.005),
    AP_GROUPINFO("MAG_LRN_LIM", 58, NavEKF3, _mag_learn_thresh, 0.02),
